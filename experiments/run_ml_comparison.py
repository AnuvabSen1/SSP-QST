...
# ---- shared physics: imported from the ssp_qst package ---------------------
import os, sys
sys.path.insert(0, os.path.join(os.path.dirname(os.path.abspath(__file__)), '..'))
from ssp_qst import (pauli_basis, project_density, random_rank_state,
                     depolarize, ls_qst_from_state, ssp_qst, fidelity)
...
def main():
    ...
    with open(os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "figs", "rrr_comparison_summary.txt"), "w") as f:
...
def diluted_main():
    ...
    with open(os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "figs", "rrr_diluted_summary.txt"), "w") as f:
